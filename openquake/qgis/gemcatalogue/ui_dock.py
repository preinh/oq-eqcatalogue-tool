...
class Ui_Dock(object):
    def setupUi(self, Dock):
        ...
        self.selectedAgenciesList.setGeometry(QtCore.QRect(200, 10, 100, 130))
        ...
        self.verticalLayoutWidget = QtGui.QWidget(self.agenciesListSelector)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(110, 10, 87, 128))
        self.verticalLayoutWidget.setObjectName(_fromUtf8("verticalLayoutWidget"))
        self.verticalLayout = QtGui.QVBoxLayout(self.verticalLayoutWidget)
        self.verticalLayout.setMargin(0)
        self.verticalLayout.setObjectName(_fromUtf8("verticalLayout"))
        self.selectAllAgencies = QtGui.QPushButton(self.verticalLayoutWidget)
        self.selectAllAgencies.setObjectName(_fromUtf8("selectAllAgencies"))
        self.verticalLayout.addWidget(self.selectAllAgencies)
        self.deselectAllAgencies = QtGui.QPushButton(self.verticalLayoutWidget)
        self.deselectAllAgencies.setObjectName(_fromUtf8("deselectAllAgencies"))
        self.verticalLayout.addWidget(self.deselectAllAgencies)
        self.selectAgencies = QtGui.QPushButton(self.verticalLayoutWidget)
        self.selectAgencies.setObjectName(_fromUtf8("selectAgencies"))
        self.verticalLayout.addWidget(self.selectAgencies)
        self.deselectAgencies = QtGui.QPushButton(self.verticalLayoutWidget)
        self.deselectAgencies.setObjectName(_fromUtf8("deselectAgencies"))
        self.verticalLayout.addWidget(self.deselectAgencies)
        self.unselectedAgenciesList = QtGui.QListWidget(self.agenciesListSelector)
        self.unselectedAgenciesList.setGeometry(QtCore.QRect(0, 10, 100, 130))
        ...
        self.gridLayout_3.addWidget(self.agenciesListSelector, 8, 0, 1, 2)
